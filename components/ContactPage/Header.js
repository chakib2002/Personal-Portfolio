            ...
            <div className="py-5 lg:py-0 lg:pt-5">
              ...
              <div className="flex justify-between flex-wrap pt-1">
                ...
                <div className="flex space-x-2">
                  <DuplicateIcon className="h-4 w-4 text-slate-900 cursor-pointer lg:hover:text-green-500 active:scale-75 transition duration-200 ease-in" />
                  <ExternalLinkIcon className="h-4 w-4 text-slate-900 cursor-pointer lg:hover:text-green-500 active:scale-75 transition duration-200 ease-in" />
                </div>
              </div>
            </div>
          </div>
