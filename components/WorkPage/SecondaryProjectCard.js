        ...
        <div className="flex space-x-3 self-center">
        {
                externals === 0 && (
                  ...
                  <a href={code} target={'_blank'} rel="noreferrer">
                    <Image
                      className="cursor-pointer active:scale-90 transition duration-300 ease-out lg:hover:scale-110"
                      src="/github.png"
                      alt="discord"
                      width="20"
                      height="20"
                  ...
                  <a href={site} target={'_blank'} rel="noreferrer">
                    <LinkIcon className="h-5 w-5 text-white cursor-pointer active:scale-90 transition duration-300 ease-out lg:hover:scale-110" />
                  </a>
                  </>
                )
              }
