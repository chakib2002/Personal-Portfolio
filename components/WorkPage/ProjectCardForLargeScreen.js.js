      ...
      {rev ? (
        <div className=" flex justify-center space-x-5">
          ...
          <div className="relative my-auto w-[50%]">
            ...
            <p
              className={`opacity-80 px-8 py-5 text-sm relative md:right-20 my-5 w-[450px] ${bg}`}
            >
              {description}
            </p>
        ...
        <div className=" flex justify-center space-x-5">
          <div className="relative my-auto text-right ">
            ...
            <h1 className="my-3 text-lg font-semibold">{title}</h1>
            <p
              className={`relative lg:ml-28 opacity-80 px-8 py-5 z-50 text-sm md:left-20 my-5 w-[450px] text-left ${bg} `}
            >
              {description}
            </p>
