      ...
      {rev ? (
        <div className=" flex justify-center space-x-5">
          ...
          <div className="relative my-auto">
            <h2 className="text-blue-500 text-sm ">{type}</h2>
            <h1 className="my-3 text-lg font-semibold">{title}</h1>
            <p className=" bg-blue-900 opacity-80 px-8 py-5 text-sm relative md:right-20 my-5 w-[450px]">
              {description}
            </p>
        ...
        <div className=" flex justify-center space-x-5">
          <div className="relative my-auto text-right">
            <h2 className="text-blue-500 text-sm ">{type}</h2>
            <h1 className="my-3 text-lg font-semibold">{title}</h1>
            <p className=" bg-blue-900 opacity-80 px-8 py-5 z-50 text-sm relative md:left-20 my-5 w-[450px] text-left">
              {description}
            </p>
